        ...
        */
        ...
        ST_INIT: begin
            if(init_cnt_r == 3'd0) begin
                ...
                if(padded_tvalid_i && padded_tsur_i == TUSER_KEY) begin
                write_en_o     = 1'b1;
                xor_en_o       = 1'b0;
                in_data_sel_o  = DATA_IN_AXI_SEL;
                ...
                padded_tready_o = 1'b1;
                if(padded_tvalid_i && padded_tsur_i == TUSER_NONCE) begin
                    write_en_o     = 1'b1;
                    xor_en_o       = 1'b0;
                    in_data_sel_o  = DATA_IN_AXI_SEL;
                    word_sel_o     = init_cnt_r[2:0];
                ...
                if ( !perm_started_r) begin
                  // Sub-phase 1: trigger permutation
                    ...
                    case (perm_ctx_r)
                        ...
                        CTX_AD: begin
                            // Domain separation: DSEP_CONST XOR into S4
                            word_sel_o = 3'd4;
                            data_o     = DSEP_CONST;
                        end
                        default: ;
